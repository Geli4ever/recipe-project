package com.svetlicic.filip.recipeproject.bootstrap;

import com.svetlicic.filip.recipeproject.model.*;
import com.svetlicic.filip.recipeproject.repositories.CategoryRepository;
import com.svetlicic.filip.recipeproject.repositories.RecipeRepository;
import com.svetlicic.filip.recipeproject.repositories.UnitOfMeasureRepository;
...
public class LoadData implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        log.debug("we are Loading Data on startup");
